...
public class ImageAdapter extends ArrayAdapter <String>{
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if (convertView == null){
            ...
            holder.mProgressBar = (ProgressBar)convertView.findViewById(R.id.jobImageProgressBar);
            holder.image = (SquareImageView)convertView.findViewById(R.id.jobImageView);
